...
- [ ] Foto `andrea.jpg` añadida en `assets/`
- [ ] Variables de entorno configuradas en Vercel
- [ ] Dominio `studiorenacer.com` verificado en Resend
- [ ] Dominio apuntando a Vercel y SSL activo
- [ ] Formulario probado de verdad (yo recibí mi email de confirmación)
- [ ] Política de privacidad redactada y enlazada
- [ ] Texto del hero revisado y ajustado a tu voz
- [ ] Foto optimizada (< 250 KB)

...
const contenido = `CONSENTIMIENTO INFORMADO Y POLÍTICA DE PRIVACIDAD
...
Sus datos se conservarán durante la vigencia de la relación terapéutica y, posteriormente, durante el plazo legalmente exigido:
— España: mínimo 5 años conforme a la Ley 41/2002 de autonomía del paciente.
— Dinamarca / Denmark: mínimo 10 años conforme al Sundhedsloven §43.
...
6. SUS DERECHOS
Tiene derecho a acceder, rectificar, suprimir, oponerse y limitar el tratamiento de sus datos, así como a la portabilidad. Puede ejercerlos dirigiéndose a andrea@studiorenacer.com.

Autoridad de control competente:
— Si reside en España: Agencia Española de Protección de Datos (www.aepd.es)
— If you reside in Denmark / Hvis du bor i Danmark: Datatilsynet (www.datatilsynet.dk)
— For other EU/EEA countries: your national supervisory authority.
...
async function seed() {
  const { data, error } = await supabase
    ...
    .upsert(
      { titulo: 'Consentimiento informado y política de privacidad', tipo: 'consentimiento_informado', version: 1, contenido },
      { onConflict: 'tipo' }
    )
    .select()
    .single();
